...
\pause
\begin{block}{}
\color{blue} \textbf{Step 5 :} \color{black} Stop or repeat step 4
\end{block}
\pause 
\begin{block}{}
\color{violet} \textbf{Step 6 :} \color{black} Increase p by 1 in each iteration of step 5
\end{block}
...
\begin{block}{Variables}
  \begin{itemize}
    \item \color{teal} \textbf{Response:} \color{black} \textbf{Daily deaths in Summer} -- 1990 to 2014 -- Montreal, Canada
...
\placefig{11.9}{.1}{width=3.5cm}{smimodel-hex}